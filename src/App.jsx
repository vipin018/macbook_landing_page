      ...
      <div className='w-full h-full bg-[#c0c0c0]'>
        ...
        <div className='absolute top-[70%] left-[90%] -translate-x-1/2 -translate-y-1/2 -pt-20  '>
          <div className='flex flex-col justify-center items-center gap-5'>
            ...
            <div className='w-20 h-20 bg-black rounded-lg overflow-hidden hover:scale-120 transition-all duration-500'> <img className='w-full h-full object-cover object-center' src="https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /> </div>
          </div>
        </div>
        <More />
      </div>
